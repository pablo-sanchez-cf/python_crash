...
# Self Destruct 2: The Wrath of Exception Handling
#
#
###################################################################################################
import random
...
##################################################################################################
    ...
    while tries < 3:
        ...
        if initiate == code:
            ...
            tries += 1 
            print "WRONG CODE. You have " + str(3 - tries) + " attempts left\n"
    print "You have tried 3 times. Aborting Self Destruction Procedures for safety concerns!!!"
